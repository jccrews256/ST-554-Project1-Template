...
- Cass Crews
  ...
  + Temporal Plots section:
    ...
    - The separate plots for each variable across hours of the day (e.g., Scatter Plot of Benzene vs. Time) precludes and comparisons. It may be better to plot hourly means for multiple variables on the same plot using either your generalized “Relative Measurement” scale or a dual-axis plot. 
    ...
    - You occasionally refer to the sensor readings as concentrations, which could confuse the reader when the original dataset has a true concentration variable for the chemical you are referring to. 
  ...
  + Non-Temporal Plots section:
    ...
    - The relationship between benzene concentration and NMHC sensor readings is incredibly strong! Good find! 
  ...
  + Temporal Numeric Summaries section:
    ...
    - Similar to my above comment, the following statement may not be true once other variables are controlled for: 
